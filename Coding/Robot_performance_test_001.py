...
output_path = "test_deep-sort-realtime/output_performance_test_001_20ea.mp4"     # define output path
...
while cap.isOpened():
    ...
    if success:
        ...
        m_status = movementStatus(track_xyxy, edge_status)                      # Movement status (m_status) gets the value returned from the "movementStatus(track_xyxy, edge_status)" function.
        '''        
